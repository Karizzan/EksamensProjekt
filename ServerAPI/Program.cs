...
namespace ServerAPI
{
	...
	new Child()
	{
		...
		{
			new Event(){EventID = 1, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Balderup", WeekNumber = 27, Workdays = "Onsdag - S�ndag (Hel Uge)", Applications = new()},
			...
			new Event(){EventID = 3, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Balderup", WeekNumber = 27, Workdays = "L�rdag - S�ndag (Weekend)", Applications = new()},
			new Event(){EventID = 4, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Balderup", WeekNumber = 28, Workdays = "Onsdag - S�ndag (Hel Uge)", Applications = new()},
			...
			new Event(){EventID = 6, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Balderup", WeekNumber = 28, Workdays = "L�rdag - S�ndag (Weekend)", Applications = new()},
			new Event(){EventID = 7, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Aarhus", WeekNumber = 30, Workdays = "Onsdag - S�ndag (Hel Uge)", Applications = new()},
			...
			new Event(){EventID = 9, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Aarhus", WeekNumber = 30, Workdays = "L�rdag - S�ndag (Weekend)", Applications = new()},
			new Event(){EventID = 10, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Aarhus", WeekNumber = 31, Workdays = "Onsdag - S�ndag (Hel Uge)", Applications = new()},
			...
			new Event(){EventID = 12, StartDate = DateTime.Now, EndDate = DateTime.Now, Location = "Aarhus", WeekNumber = 31, Workdays = "L�rdag - S�ndag (Weekend)", Applications = new()},
